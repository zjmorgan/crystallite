...
current density is :math:`\sigma_1E_\mathrm{in}`; for the perfect conductor it is
...
CASES = {
    ...
    "soft": (0.25, r"soft inclusion, $\sigma_1/\sigma_0=1/4$"),
    "hard": (4.0, r"hard inclusion, $\sigma_1/\sigma_0=4$"),
